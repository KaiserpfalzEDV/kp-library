...
import de.kaiserpfalzedv.office.library.model.BorrowHistoryEntry;
...
public class BorrowHistoryEntryJPA implements BorrowHistoryEntry {
    @Schema(
            title = "ID",
