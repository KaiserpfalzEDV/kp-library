 ...
 * {@link de.kaiserpfalzedv.office.library.api.model.BorrowHistoryEntry}.</p>
 *
...
@Jacksonized
@Entity
@Table(name = "BORROWHISTORY", schema = AboutJPA.DB_SCHEMA)
...
public class BorrowHistoryEntryJPA implements de.kaiserpfalzedv.office.library.api.model.BorrowHistoryEntry {
    @Schema(
            title = "ID",
