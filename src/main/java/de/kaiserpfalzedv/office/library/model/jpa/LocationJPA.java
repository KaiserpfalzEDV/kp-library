...
/**
 * <p>Location -- the JPA implementation of {@link de.kaiserpfalzedv.office.library.api.model.Location}.</p>
 *
...
public class LocationJPA extends BaseNamedResourceJPA implements de.kaiserpfalzedv.office.library.api.model.Location {
    @Getter
    ...
    @JsonIgnore
    @Override
    public Optional<de.kaiserpfalzedv.office.library.api.model.Location> getPartOf() {
    ...
    @JsonIgnore
    @Override
    public Set<de.kaiserpfalzedv.office.library.api.model.Location> getSubLocations() {
        return subLocations.stream()
                .map(d -> (de.kaiserpfalzedv.office.library.api.model.Location) d)
